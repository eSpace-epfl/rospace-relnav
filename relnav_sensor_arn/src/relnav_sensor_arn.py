...
import rospace_lib
from rospace_msgs.msg import SatelitePose, AzimutElevationRangeStamped
from PaperAnglesSensor import PaperAnglesSensor
...
if __name__ == '__main__':
    rospy.init_node('relnav_sensor_arn', anonymous=True)
    rospy.loginfo("relnav_sensor_arn started")
